...
print("BOOT: File execution started")
...
if __name__ == "__main__":
    print("BOOT: Starting Flask thread")
    Thread(target=run_flask, daemon=True).start()
    print("BOOT: About to call bot.run()")
